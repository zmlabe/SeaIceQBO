"""
Plot presentation figure for WAFz and relative change in refractive index
...
limit = np.arange(-0.5,0.501,0.02)
...
plt.savefig(directoryfigure + 'WAFz_QBO_%s_WaveGuide_Presentation.png' % period,dpi=300)
