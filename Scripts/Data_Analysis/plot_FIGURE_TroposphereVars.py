...
varnamesn = [r'U300',r'U300',r'Z500',r'Z500',r'Wave 1',r'Wave 1']
...
for v in range(6):
    ...
    if varnamesn[v] == 'U300':
        ...
        limit = np.arange(-30,31,2)
        barlim = np.arange(-30,31,15) 
    
    m = Basemap(projection='ortho',lon_0=0,lat_0=89,resolution='l',
                area_thresh=10000.)
 
    if varnamesn[v] == 'U300' or varnamesn[v] == 'Z500':
...
fig.subplots_adjust(wspace=-0.63,hspace=0)
    
plt.savefig(directoryfigure + 'TroposphereVars.png',dpi=900)
