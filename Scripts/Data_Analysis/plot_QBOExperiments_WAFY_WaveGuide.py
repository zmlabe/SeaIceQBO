...
### Retrieve WAFz
diffruns_mo,pruns_mo,lat,lon,lev = readWAFy(varnames,qbophase)
...
cbar.set_label(r'\textbf{Normalized WAFy}',fontsize=11,color='dimgray',labelpad=1)
...
plt.savefig(directoryfigure + 'WAFy_QBO_%s_WaveGuide.png' % period,dpi=300)
