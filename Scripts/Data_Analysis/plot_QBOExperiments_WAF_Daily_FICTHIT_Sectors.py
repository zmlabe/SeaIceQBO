...
### Read in data
diffwafz,pwafz,lev = readWAF('WAFZv',runnames,experiments,qbophase)
diffwafy,pwafy,lev = readWAF('WAFYv',runnames,experiments,qbophase)
...
if MASK == True:
    plt.savefig(directoryfigure + 'allExperiments_WAF_MASK_daily_FICTHIT_%s_Sectors.png' % regions,
                dpi=300)
else:
    plt.savefig(directoryfigure + 'allExperiments_WAF_daily_FICTHIT_%s_Sectors.png' % regions,
        dpi=300)
