...
#wavehitpos[np.where(wavehitpos<0.001)] = 0.
#wavehitneg[np.where(wavehitneg<0.001)] = 0.
...
#
#cs = plt.contourf(lat2,lev2,wavediff.transpose(),limit,extend='both')
...
#plt.xlim([0,90])
#plt.ylim([1000,10])
#plt.savefig(directoryfigure + 'refractiveIndexTesttttt.png',dpi=300)
