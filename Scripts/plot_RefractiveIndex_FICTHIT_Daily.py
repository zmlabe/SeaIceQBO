...
-----
    Author    : Zachary Labe
    Date      : 29 May 2018
    Reference : Karami et al. [2016, ACP]
"""
...
nlev = 17
nlon = 144
nday = 30 # September through March
...
desired_levs = [ 1000.,925.,850.,700.,600.,500.,400.,300.,250.,200.,150.,
                100.,70.,50.,30.,20.,10.]
...
### Begin Loop #
total_years = np.linspace(0,200,num=200-0+1)
