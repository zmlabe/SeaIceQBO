...
vardiff = np.nanmean(var_mofictneg[:,3,:,:],axis=0) - np.nanmean(var_mohitpos[:,3,:,:],axis=0)
varpos = np.nanmean(var_mofictpos[:,3,:,:],axis=0)
varneg = np.nanmean(var_mofictneg[:,3,:,:],axis=0)
