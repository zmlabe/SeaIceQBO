...
for v in range(len(varnames)):
    ...
    stat_fsubcitpos,pvalue_fsubcitpos = UT.calc_indttest(var_mo[1][pos_fsub,:,:],
                                                       var_mo[0][pos_cit,:,:])
    stat_fsubcitnon,pvalue_fsubcitnon = UT.calc_indttest(var_mo[1][non_fsub,:,:],
                                                   var_mo[0][non_cit,:,:])
    stat_fsubcitneg,pvalue_fsubcitneg = UT.calc_indttest(var_mo[1][neg_fsub,:,:],
                                               var_mo[0][neg_cit,:,:])
    
    stat_fpolcitpos,pvalue_fpolcitpos = UT.calc_indttest(var_mo[2][pos_fpol,:,:],
                                                       var_mo[0][pos_cit,:,:])
    stat_fpolcitnon,pvalue_fpolcitnon = UT.calc_indttest(var_mo[2][non_fpol,:,:],
                                                   var_mo[0][non_cit,:,:])
    stat_fpolcitneg,pvalue_fpolcitneg = UT.calc_indttest(var_mo[2][neg_fpol,:,:],
                                               var_mo[0][neg_cit,:,:])
    ...
    if MASK == True:
        plt.savefig(directoryfigure + 'allExperiments_%s_MASK_daily_regional.png' % varnames[v],
                    dpi=300)
    else:
        plt.savefig(directoryfigure + 'allExperiments_%s_daily_regional.png' % varnames[v],
            dpi=300)
